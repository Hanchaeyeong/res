$(document).ready(function(){
  ...
  minimize_header();
    ...
    const swiper2 = new Swiper('.new-menu',{
        slidesPerView:1.5,
        spaceBetween:20,
        //3초마다 자동실행 
        autoplay:{
    ...
    //스크롤 내릴 때마다 section안에 자식 콘텐츠들이 서서히 나타나는 애니메이션
